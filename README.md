...
### 1. AI 助手对话与智能规划
![AI 助手](study_dashboard/docs/images/chat.png)
*AI 助手通过 Function Calling 自动调用统计工具，并提供个性化建议。*

### 2. 今日学习记录
![今日记录-1](study_dashboard/docs/images/record1.png)
![今日记录-2](study_dashboard/docs/images/record2.png)
*简洁的响应式界面，支持任务快速录入和执行情况追踪。*

### 3. 数据看板统计
![数据看板](study_dashboard/docs/images/dashboard.png)
*自动汇总学习数据，可视化展示效率趋势和学科分布。*

### 4. 智能分析报告
![智能分析](study_dashboard/docs/images/analysis.png)
